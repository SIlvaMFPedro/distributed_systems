...
public class Repository implements Repository_Broker, Repository_Spec{
     ...
     */
    public Repository(LogRepository log, int maxRaces){
    ...
    */
     ...
     */
    @Override
    public boolean checkWin(int horse_id){
        LinkedList w;
        boolean b = false;
        rl.lock();
        try{
            System.out.print("S : Spectator checking if there are any winners\n");
