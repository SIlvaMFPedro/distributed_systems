...
public class MyThreadHorses extends Thread {
    ...
    //Monitors for Horses
    private final Stable_Horses horse_stable; 
    private final Paddock_Horses horse_paddock;
    private final RaceTrack_Horses horse_track;
     ...
     */
    public MyThreadHorses(int id, Stable_Horses horse_stable, Paddock_Horses horse_paddock, RaceTrack_Horses horse_track, int agility){
        this.id = id;
