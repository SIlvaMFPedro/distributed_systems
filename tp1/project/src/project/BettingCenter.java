 ...
 */
public class BettingCenter implements BettingCenter_Broker, BettingCenter_Spec {
     ...
     */
    public BettingCenter(LogRepository log, int spec_total){
    ...
    public void waitForBets(){
        ...
        try{
            ...
            try{
                ...
                Logger.getLogger(BettingCenter.class.getName()).log(Level.SEVERE, null, ex);
            }
        }finally{
            rl.unlock();
        }
     ...
     */
    @Override
    public void placeABet(int spec_id, int horse_id, int bet_value){
        Bet aposta;
        rl.lock();
        ...
        try{
            ...
            log.setSpectatorMoney(spec_id, spectator.getMoney());
            log.changeLog();
        } catch (InterruptedException ex) {
            Logger.getLogger(BettingCenter.class.getName()).log(Level.SEVERE, null, ex);
        }finally{
    ...
    public void collectGains(int id){
        ...
        try{
            ...
            //collect $$$
            MyThreadSpec spectator = (MyThreadSpec) Thread.currentThread();
            int receive_money = Math.min(prize_per_winner,horse_bets.get(id).getValue()*spec_total);
            ...
            log.setSpectatorMoney(id, spectator.getMoney());
            log.changeLog();
        } catch (InterruptedException ex) {
            Logger.getLogger(BettingCenter.class.getName()).log(Level.SEVERE, null, ex);
        }finally{
